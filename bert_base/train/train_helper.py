...
def get_args_parser():
    ...
    if os.name == 'nt':
        ...
        bert_path = 'D:\\Program Files\\JetBrains\\PyCharm 2017.2.4\\bert_ner_3\\cased_L-12_H-768_A-12'
        # root_path = r'C:\workspace\python\BERT-BiLSTM-CRF-NER'
        root_path = 'D:\\Program Files\\JetBrains\\PyCharm 2017.2.4\\bert_ner_3'
    else:
    ...
    group2.add_argument('-do_eval', action='store_false', default=True, # do_train do_eval两个同时为True才训练，一个不为True就跑predict
    ...
    group2.add_argument('-learning_rate', type=float, default=1e-3, # 只学习后面网络参数的话这个放大点没问题吧?原始1e-5
