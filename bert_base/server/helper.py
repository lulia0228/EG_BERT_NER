...
def get_args_parser():
    ...
    bert_model_dir = r'D:\Program Files\JetBrains\PyCharm 2017.2.4\bert_ner_3\cased_L-12_H-768_A-12'
    model_dir = r'D:\Program Files\JetBrains\PyCharm 2017.2.4\bert_ner_3\output'
    model_pb_dir = r'D:\Program Files\JetBrains\PyCharm 2017.2.4\bert_ner_3\pb_dir'

    group1 = parser.add_argument_group('File Paths',
                                       'config the path, checkpoint and filename of a pretrained/fine-tuned BERT model')
    # 如果要使用default值，不能设置required=true
    group1.add_argument('-bert_model_dir', type=str,default=bert_model_dir
                        ,help='chinese google bert model path')

    group1.add_argument('-model_dir', type=str, default=model_dir,
                        help='directory of a pretrained BERT model')
    group1.add_argument('-model_pb_dir', type=str, default=model_pb_dir,
                        help='directory of a pretrained BERT model')
    ...
    group3.add_argument('-gpu_memory_fraction', type=float, default=0.7,
