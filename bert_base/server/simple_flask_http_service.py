...
# 一个简单的service启动，没有run.py里面的多线程东西，可以有个简单的清晰认识
...
# 特别注意do_lower_case要和训练模型一致
tokenizer = tokenization.FullTokenizer(vocab_file=os.path.join(bert_dir, 'vocab.txt'), do_lower_case=False)

app = flask.Flask(__name__)

@app.route('/ner_predict_service', methods=['POST'])
